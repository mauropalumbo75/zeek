...
refine connection SMB_Conn += {
	...
	function proc_smb2_create_request(h: SMB2_Header, val: SMB2_create_request): bool
		...
		if ( smb2_create_request )
			...
			//requestinfo->Assign(9, bytestring_to_val(${val.contexts}));
			...
			requestinfo->Assign(9, val_mgr->GetCount(${val.contexts.next_offset}));
			//requestinfo->Assign(10, val_mgr->GetCount(${val.contexts.name_offset}));
			//requestinfo->Assign(11, val_mgr->GetCount(${val.contexts.name_len}));
			//requestinfo->Assign(12, val_mgr->GetCount(${val.contexts.data_offset}));
			//requestinfo->Assign(13, val_mgr->GetCount(${val.contexts.data_len}));
...
type SMB2_create_request(header: SMB2_Header) = record {
	...
	create : case context_len of {
		0       -> blank    : empty;
		default -> contexts : SMB2_create_context_value;
