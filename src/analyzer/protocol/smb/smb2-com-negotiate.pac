...
type SMB3_negotiate_context_values = record {
	...
	data			: bytestring &length = data_lenght;  	#TODO better split this with SMB3_preauth_integrity_capabilities/SMB3_encryption_capabilities
									# based on context_type
};
...
type SMB2_negotiate_request(header: SMB2_Header) = record {
	...
	dialects          	: uint16[dialect_count];	 # array of SMB dialects accepted
